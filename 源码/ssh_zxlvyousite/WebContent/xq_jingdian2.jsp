...
<div class="wt1002 fwmain">
	<div class="fwmain_nright r mTop10">
    	<div class="label">
        	<div class="label_head"><div class="label_title">景点详情</div></div>
            <input type="hidden" name="id" value="${bean.id }"/>
            <div class="about_con">
            	 <div class="news_detail_title">${bean.name} </div>
                 <div class="news_detail_info">
                 	<div class="news_detail_time">地址:${bean.address}</div>
                    <div class="news_detail_from">票价:${bean.price}（元/人）</div>
                    <div class="news_detail_tool">发布时间：${bean.createtime}</div>
                 </div>
                <div class="news_detail_cont"> <div class="news_detail_cont"><img src='<%=basePath %>${bean.imgpath}'/></div>
          ...
          <div class="label_head"><div class="label_title">
           ...
           <div class="about_con">
              ...
              <form action="method!jingdian_dianpingadd"method="post" onsubmit="return checkform()">
                <div class="about_con">&nbsp;&nbsp;&nbsp;&nbsp;  
                 <input type="hidden" name="id" value="${bean.id }"/>
