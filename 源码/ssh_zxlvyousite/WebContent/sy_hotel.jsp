...
<div class="wt1002 fwmain">
	<div class="fwmain_nright r mTop10">
     <div class="label">
      <div class="label_head"><div class="label_title">度假酒店列表</div></div>
<div>
<form action="method!sy_hotel"  method="post">
...
<input type="submit"  value="查询"/>
           ...
           <li><a href="method!xq_hotel?id=${bean.id }"><img src="<%=basePath %>${bean.imgpath}"/></a><a href="method!xq_hotel?id=${bean.id }">${bean.name }，${bean.price }(元/日)</a></li>
             </c:forEach>
            </ul> 
            <div class="clear"></div>
