...
<div class="wt1002 fwmain">
	<div class="fwmain_nright r mTop10">
    	<div class="label">
        	<div class="label_head"><div class="label_title">旅游攻略</div></div>
             <ul class="label_pad mTop10">
             	 <c:forEach items="${list}" var="bean">
                <li><span>${fn:substring(bean.createtime,0, 10)} </span><a href="method!xq_raiders?id=${bean.id }">${bean.name } </a></li>
                 </c:forEach>
            </ul>
            <div class="clear"></div>
