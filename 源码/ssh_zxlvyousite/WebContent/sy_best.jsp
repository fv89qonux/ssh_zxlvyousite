...
<div class="wt1002 fwmain">
	<div class="fwmain_nright r mTop10">
    	<div class="label">
        	<div class="label_head"><div class="label_title">最受欢迎景点</div></div>
<div>
	<form action="method!xq_raiders?id=2"  method="post">
	 &nbsp; &nbsp; 
      ...
      <ul class="prolist mTop10">
        <c:forEach items="${list}"  var="bean">
           <li>
	           <a href="method!xq_jingdian?id=${bean.id }">
	           <img src="<%=basePath %>${bean.imgpath}"/></a>
	           <a href="#">${bean.name }</a>
           </li>
         </c:forEach>
      </ul> 
