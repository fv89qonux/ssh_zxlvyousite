...
<div class="wt1002 fwmain">
	<div class="fwmain_nright r mTop10">
    	<div class="label">
    	 <form action="method!sy_hoteladd2" method="post"  onsubmit="return checkform()">
    	  <input type="hidden" name="id" value="${bean.id }"/>
        	<div class="label_head"><div class="label_title">酒店预定</div></div>
            <div class="about_con">
            	<p>&nbsp;&nbsp;&nbsp;&nbsp;酒店名称:${bean.name }</p>
            	<p>&nbsp;&nbsp;&nbsp;&nbsp;预定价格:${bean.price }（元/日）</p>
            	...
            	<p>&nbsp;&nbsp;&nbsp;&nbsp;预定天数:<input style="width:30%;" type="text" name="tianshu" id="tianshuid"></p>
            	<p>&nbsp;&nbsp;&nbsp;&nbsp;预定房间数:<input style="width:30%;" type="text" name="number" id="numberid"></p>
...
function checkform()
{
	...
	if (document.getElementById('tianshuid').value=="")
	{
		alert("酒店预定天数不能为空");
		return false;
	}
	...
	if(!valid.test(document.getElementById('tianshuid').value)){
		alert("酒店预定天数必须是数字");
		return false;
	}
