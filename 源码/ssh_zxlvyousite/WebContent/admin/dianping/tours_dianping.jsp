...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  <TR height=28>
    ...
    <TD background=images/title_bg1.jpg> <span style="float:left">当前位置是：旅游点评管理-》旅游点评信息</span></TD></TR>
  <TR>
...
<form action="method!tours_dianping"  method="post">
...
<input type="submit"  value="查询"/>
 ...
 <table class="table_a" border="1" width="100%"> 	
   ...
   <tr id="product1">
    <TD align="center" >${bean.tours.category }</TD>
     <TD align="center" >${bean.tours.biaoti }</TD>
