...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  <TR height=28>
    ...
    <TD background=images/title_bg1.jpg> <span style="float:left">当前位置是：景点信息管理-》景点信息</span></TD></TR>
    </TABLE>
    
 <div class="div_search">
<form action="method!jingdianlist"  method="post">
...
<input type="submit"  value="查询"/>
 ...
 <table class="table_a" border="1" width="100%"> 	
    ...
    <TD align="center" >景点名称</TD>
      <TD align="center" >票价（元/人）</TD>
            <TD align="center" >地址</TD>
               <TD align="center" >景点图片</TD>
                  <TD align="center" >景点描述</TD>
   ...
   <tr id="product1">
    ...
    <TD align="center"> 
  	<a href="method!jingdianupdate?id=${bean.id }">修改</a> &nbsp; &nbsp; &nbsp;
  	<a href="method!jingdiandelete?id=${bean.id }" onclick=" return confirm('确定要删除吗?'); ">删除</a>
